...
// import PortfolioImg1 from "../assets/portfolio-img-2.jpg"; // Add your first portfolio image
// import PortfolioImg2 from "../assets/portfolio-img-4.jpg"; // Add your second portfolio image
// import PortfolioImg3 from "../assets/portfolio-img-2.jpg"; // Add your third portfolio image
...
//   const ImageCarousel = () => {
//     const staticImages = [PortfolioImg1, PortfolioImg2, PortfolioImg3]; // Three images for the carousel
...
//         {/* Carousel Image */}
//         <div
//           className="overflow-hidden w-full h-96 rounded-lg relative border-4 border-white"
//           style={{ width: "80%" }}
//         >
//           <img
...
//             style={{
//               animation: `zoomEffect 2s ease-in-out infinite`, // Update animation duration to match the interval
//               transform: `scale(1.1)`,
//             }}
//           />
//         </div>
...
//       {/* Social Media Icons */}
//       <div className="absolute top-5 right-5 flex space-x-3 cur text-lg text-white">
...
//       {/* Footer Text */}
//       <div className="absolute bottom-5 text-white right-5 text-gray-200 text-lg">
//         © 2024 MegaOne
//       </div>

//       <div className="relative z-10 flex flex-col items-center justify-center px-10 p-14 space-y-10 h-full text-white">
...
//             </h1>
//           </div>
//           {/* Right Side: Count-up numbers */}
//           <div className="flex flex-row justify-around">
//             {counts.map((count, index) => (
//               <div key={index} className="text-4xl font-bold text-center mx-4">
//                 {count} <br />
