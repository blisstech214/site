        ...
        <>
          ...
          <div className="relative lg:py-10 py-10 items-center justify-between p-8 md:p-16 space-y-6 h-full text-white">
            <div className="flex flex-col lg:flex-row justify-between items-center w-full md:px-28">
              <div className="text-left lg:py-8 py-5  max-w-lg">
            ...
            <div
              className="flex flex-col md:flex-row md:py-8 py-0 justify-center space-y-6 md:space-y-0 md:space-x-8 mt-4 md:mt-5"
              data-aos="zoom-in"
            ...
            >
              {visibleIndices.map((index) => {
                ...
                return (
                  ...
                  >
                    <img
                      className="w-full h-20 lg:h-80 text-base lg:text-lg object-center p-3 opacity-90"
